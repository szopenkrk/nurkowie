...
<?php } if ($this->_rootref['ENABLE_GG']) {  ?>
	...
	<dl>
		<dt><label for="gg"><?php echo ((isset($this->_rootref['L_GG'])) ? $this->_rootref['L_GG'] : ((isset($user->lang['GG'])) ? $user->lang['GG'] : '{ GG }')); ?>:</label></dt>
		<dd><input type="text" name="gg" id="gg" value="<?php echo (isset($this->_rootref['GG'])) ? $this->_rootref['GG'] : ''; ?>" class="inputbox" /></dd>
	</dl>
	<?php } if ($this->_rootref['ENABLE_TLEN']) {  ?>  
	<dl>
		<dt><label for="tlen"><?php echo ((isset($this->_rootref['L_TLEN'])) ? $this->_rootref['L_TLEN'] : ((isset($user->lang['TLEN'])) ? $user->lang['TLEN'] : '{ TLEN }')); ?>:</label></dt>
		<dd><input type="text" name="tlen" id="tlen" value="<?php echo (isset($this->_rootref['TLEN'])) ? $this->_rootref['TLEN'] : ''; ?>" class="inputbox" /></dd>
	</dl>
	<?php } if ($this->_rootref['ENABLE_SKYPE']) {  ?>  
	<dl>
		<dt><label for="skype"><?php echo ((isset($this->_rootref['L_SKYPE'])) ? $this->_rootref['L_SKYPE'] : ((isset($user->lang['SKYPE'])) ? $user->lang['SKYPE'] : '{ SKYPE }')); ?>:</label></dt>
		<dd><input type="text" name="skype" id="skype" value="<?php echo (isset($this->_rootref['SKYPE'])) ? $this->_rootref['SKYPE'] : ''; ?>" class="inputbox" /></dd>
	</dl>

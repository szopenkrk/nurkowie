...
<div class="panel">
	...
	<fieldset>
	<?php if ($this->_rootref['ERROR']) {  ?><p class="error"><?php echo (isset($this->_rootref['ERROR'])) ? $this->_rootref['ERROR'] : ''; ?></p><?php } if ($this->_rootref['ENABLE_GG']) {  ?>

	<dl>
		<dt><label for="gg"><?php echo ((isset($this->_rootref['L_UCP_GG'])) ? $this->_rootref['L_UCP_GG'] : ((isset($user->lang['UCP_GG'])) ? $user->lang['UCP_GG'] : '{ UCP_GG }')); ?>:</label></dt>
		<dd><input type="text" name="gg" id="gg" maxlength="15" value="<?php echo (isset($this->_rootref['GG'])) ? $this->_rootref['GG'] : ''; ?>" class="inputbox" /></dd>
	</dl>
	<?php } if ($this->_rootref['ENABLE_TLEN']) {  ?>  
	<dl>
		<dt><label for="tlen"><?php echo ((isset($this->_rootref['L_UCP_TLEN'])) ? $this->_rootref['L_UCP_TLEN'] : ((isset($user->lang['UCP_TLEN'])) ? $user->lang['UCP_TLEN'] : '{ UCP_TLEN }')); ?>:</label></dt>
		<dd><input type="text" name="tlen" id="tlen" maxlength="255" value="<?php echo (isset($this->_rootref['TLEN'])) ? $this->_rootref['TLEN'] : ''; ?>" class="inputbox" /></dd>
	</dl>
	<?php } if ($this->_rootref['ENABLE_SKYPE']) {  ?>  
	<dl>
		<dt><label for="skype"><?php echo ((isset($this->_rootref['L_UCP_SKYPE'])) ? $this->_rootref['L_UCP_SKYPE'] : ((isset($user->lang['UCP_SKYPE'])) ? $user->lang['UCP_SKYPE'] : '{ UCP_SKYPE }')); ?>:</label></dt>
		<dd><input type="text" name="skype" id="skype" maxlength="255" value="<?php echo (isset($this->_rootref['SKYPE'])) ? $this->_rootref['SKYPE'] : ''; ?>" class="inputbox" /></dd>
	</dl>
	<?php } if ($this->_rootref['ENABLE_ICQ']) {  ?>
	...
	<?php } if ($this->_rootref['ENABLE_AIM']) {  ?>  
	<dl>
	...
	<?php } if ($this->_rootref['ENABLE_MSN']) {  ?>  
	<dl>
	...
	<?php } if ($this->_rootref['ENABLE_YIM']) {  ?>  
	<dl>
	...
	<?php } if ($this->_rootref['ENABLE_JABBER']) {  ?>  
	<dl>

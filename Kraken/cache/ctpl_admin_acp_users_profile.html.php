<?php if (!defined('IN_PHPBB')) exit; ?><form id="user_profile" method="post" action="<?php echo (isset($this->_rootref['U_ACTION'])) ? $this->_rootref['U_ACTION'] : ''; ?>">
	...
	<?php if ($this->_rootref['ENABLE_GG']) {  ?>
	...
	<dl>
		...
		<dd><input type="text" id="gg" name="gg" value="<?php echo (isset($this->_rootref['GG'])) ? $this->_rootref['GG'] : ''; ?>" /></dd>
	</dl>
	...
	<dl>
		...
		<dd><input type="text" id="tlen" name="tlen" value="<?php echo (isset($this->_rootref['TLEN'])) ? $this->_rootref['TLEN'] : ''; ?>" /></dd>
	</dl>
	...
	<dl>
		...
		<dd><input type="text" id="skype" name="skype" value="<?php echo (isset($this->_rootref['SKYPE'])) ? $this->_rootref['SKYPE'] : ''; ?>" /></dd>
	</dl>

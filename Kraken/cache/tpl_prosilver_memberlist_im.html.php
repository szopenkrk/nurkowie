	...
	<?php } if ($this->_rootref['S_SEND_AIM']) {  ?>
		...
		<dl class="fields2">
			...
			<dd><a href="http://www.aim.com"><?php echo ((isset($this->_rootref['L_IM_DOWNLOAD_APP'])) ? $this->_rootref['L_IM_DOWNLOAD_APP'] : ((isset($user->lang['IM_DOWNLOAD_APP'])) ? $user->lang['IM_DOWNLOAD_APP'] : '{ IM_DOWNLOAD_APP }')); ?></a> | <a href="http://www.aim.com/products/express"><?php echo ((isset($this->_rootref['L_IM_AIM_EXPRESS'])) ? $this->_rootref['L_IM_AIM_EXPRESS'] : ((isset($user->lang['IM_AIM_EXPRESS'])) ? $user->lang['IM_AIM_EXPRESS'] : '{ IM_AIM_EXPRESS }')); ?></a></dd>
				<?php if ($this->_rootref['S_SEND_SKYPE']) {  ?>

		<dl class="fields2">
			<dt>&nbsp;</dt>
			<dd><a href="<?php echo (isset($this->_rootref['U_SKYPE_CALL'])) ? $this->_rootref['U_SKYPE_CALL'] : ''; ?>"><?php echo ((isset($this->_rootref['L_IM_CALL'])) ? $this->_rootref['L_IM_CALL'] : ((isset($user->lang['IM_CALL'])) ? $user->lang['IM_CALL'] : '{ IM_CALL }')); ?></a></dd>
			<dd><a href="<?php echo (isset($this->_rootref['U_SKYPE_CONTACT'])) ? $this->_rootref['U_SKYPE_CONTACT'] : ''; ?>"><?php echo ((isset($this->_rootref['L_IM_ADD_CONTACT'])) ? $this->_rootref['L_IM_ADD_CONTACT'] : ((isset($user->lang['IM_ADD_CONTACT'])) ? $user->lang['IM_ADD_CONTACT'] : '{ IM_ADD_CONTACT }')); ?></a></dd>
			<dd><a href="<?php echo (isset($this->_rootref['U_SKYPE_MESSAGE'])) ? $this->_rootref['U_SKYPE_MESSAGE'] : ''; ?>"><?php echo ((isset($this->_rootref['L_IM_SEND_MESSAGE'])) ? $this->_rootref['L_IM_SEND_MESSAGE'] : ((isset($user->lang['IM_SEND_MESSAGE'])) ? $user->lang['IM_SEND_MESSAGE'] : '{ IM_SEND_MESSAGE }')); ?></a></dd>
			<dd><a href="http://www.skype.com/intl/pl/download/"><?php echo ((isset($this->_rootref['L_IM_DOWNLOAD_APP'])) ? $this->_rootref['L_IM_DOWNLOAD_APP'] : ((isset($user->lang['IM_DOWNLOAD_APP'])) ? $user->lang['IM_DOWNLOAD_APP'] : '{ IM_DOWNLOAD_APP }')); ?></a></dd>
		</dl>
	<?php } ?>

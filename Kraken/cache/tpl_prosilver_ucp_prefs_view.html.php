...
<div class="panel">
	<div class="inner"><span class="corners-top"><span></span></span>
		...
		<?php } if ($this->_rootref['S_TOPIC_PREVIEW']) {  ?>

			<dl>
				<dt><label for="topic_preview1"><?php echo ((isset($this->_rootref['L_DISPLAY_TOPIC_PREVIEW'])) ? $this->_rootref['L_DISPLAY_TOPIC_PREVIEW'] : ((isset($user->lang['DISPLAY_TOPIC_PREVIEW'])) ? $user->lang['DISPLAY_TOPIC_PREVIEW'] : '{ DISPLAY_TOPIC_PREVIEW }')); ?>:</label></dt>
				<dd>
					<label for="topic_preview1"><input type="radio" name="topic_preview" id="topic_preview1" value="1"<?php if ($this->_rootref['S_DISPLAY_TOPIC_PREVIEW']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label> 
					<label for="topic_preview0"><input type="radio" name="topic_preview" id="topic_preview0" value="0"<?php if (! $this->_rootref['S_DISPLAY_TOPIC_PREVIEW']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label>
				</dd>
			</dl>
		<?php } ?>
